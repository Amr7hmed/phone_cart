...
function Singup() {
    return (<>
        ...
        <button type="button" className="btn btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#SingupModal">
            <span className="fa fa-user-plus me-2"></span>
            Register
        </button>

        {/* <!-- Modal --> */}
        <div className="modal fade" id="SingupModal" tabIndex="-1" aria-labelledby="SingupModal" aria-hidden="true" >
